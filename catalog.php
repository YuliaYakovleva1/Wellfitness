    ...
    <main>
        <div class="container-full">
            <div class="for__home__bread">
                ...
                <p class="for__home__bread__text">Кардиотренажеры</p>
            </div>
        </div>
        ...
        <section class="tabs">
            <div class="container-full">
                <h3 class="main__title catalog__title">Кардиотренажеры</h3>
                ...
                <div class="tabs__content2">
                    <div class="tabs__item tabs__content__main active" id="tab_1">
                        <div class="sale row justify__content__between justify__content__start">
                            <?php
